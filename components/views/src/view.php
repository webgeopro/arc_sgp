...
<li class="article <?=$oneArticle?>">
    <h2 class="article_title">
        <a class="article_link" href="/view/<?=$a['url']?>"><?=$a['topic']?></a>
    </h2>

    <div class="article_top">
        <ul>
            <li class="article_date"><i class="fa fa-calendar"></i>&nbsp;<?=$a['humanDate']?></li>
            <?//todo Несколько рубрик?>
            <li class="article_blog"><i class="fa fa-newspaper-o"></i>&nbsp;<?=$a['blog']['name']?></li>
            <li class="article_author">
                <i class="fa fa-pencil"></i>&nbsp;<?=$a['author']['fname'] .' '. $a['author']['lname']?>
                <!--<a href="/blog/author/<?#=$a['author']['nick']?>" title="Все материалы этого автора">auth</a>-->
            </li>
